      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12 reveal-animation">
          ...
          <p className="text-white/70 max-w-3xl mx-auto">
            Watch highlights from our previous events and get a glimpse of what to expect at TEDxCUET 2024.
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto reveal-animation">
          <div className="glass-card rounded-xl overflow-hidden aspect-video relative group">
            <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent opacity-100 group-hover:opacity-0 transition-opacity duration-300"></div>
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <button className="play-button group-hover:scale-110 transition-transform duration-300">
                <svg 
